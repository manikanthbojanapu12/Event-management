...
function initThemeToggle() {
  ...
  navRight.insertBefore(button, navRight.querySelector('.menu-toggle') || null);
  const storedTheme = localStorage.getItem('theme');
  const defaultTheme = storedTheme || (window.matchMedia && window.matchMedia('(prefers-color-scheme: light)').matches ? 'light' : 'dark');
